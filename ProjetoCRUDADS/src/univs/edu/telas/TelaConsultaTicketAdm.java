 ...
 * @author Akari
 */
public class TelaConsultaTicketAdm extends javax.swing.JFrame {
    
    Ticket ticket = new Ticket();
    TicketDAO dao = new TicketDAO();
    UsuarioAjudado usuario = new UsuarioAjudado(); 
    
    public TelaConsultaTicketAdm() {
        initComponents();
        atualizarTabela();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaConsultaTicketAdm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaConsultaTicketAdm().setVisible(true);
            }
        });
    }
