 ...
 * @author Akari
 */
public class TelaEditarAjudado extends javax.swing.JFrame {

    UsuarioAjudado usuario = new UsuarioAjudado();
    UsuarioDAO dao = new UsuarioDAO();

    public TelaEditarAjudado() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaEditarAjudado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaEditarAjudado().setVisible(true);
            }
        });
    }
